...
//        web.loadUrl(url);
        ...
        webView1 = (WebView) findViewById(R.id.youtube);

        webView1.setWebViewClient(new Youtube_web.MyBrowser());
        String url = "https://www.youtube.com/channel/UCyFKzfA-4h2f3-Va75ljPRA";
